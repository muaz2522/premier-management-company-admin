...
function EditProfile() {
    return (
        <div className="bg-ground-color">
            <section className="custom-min:p-8">
                <div className="grid custom-min:grid-cols-1 sm:grid-cols-[1fr_5fr] md:grid-cols-1 lg:grid-cols-[1fr_5fr] gap-8">
                    <div className='flex custom-min:flex-row md:flex-row sm:flex-col custom-min:items-center lg:items-start lg:flex-col gap-4'>
