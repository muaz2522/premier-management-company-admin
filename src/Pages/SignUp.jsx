...
function SignUp() {
  return (
    <section className='min-h-[calc(100vh-60px)] bg-ground-color'>
      <div className="custom-min:flex custom-min:flex-col md:flex-row  custom-min:gap-8 sm:gap-40 custom-min:px-12 md:w-4/5 lg:w-3/4 pt-12 mx-auto">
        <div className='md:w-[34rem] pt-8'>
          ...
          <ButtonLink link="/login" text="Have an account" className="py-2 text-lg text-semibold px-4" classLink="hover:text-footer-color text-white" />
        </div>
