...
function Login() {
  return (
    <section className='min-h-[calc(100vh-60px)] bg-ground-color pb-8'>
      <div className="custom-min:flex custom-min:flex-col md:flex-row custom-min:items-center items-center custom-min:gap-8 sm:gap-40 custom-min:px-8 md:w-4/5 lg:w-3/4 pt-20 mx-auto">
        <div className='md:w-[34rem]'>
          ...
          <p className='mb-3 text-medium leading-8' style={{ color: "var(--color-main)" }}>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Libero sequi amet cupiditate, quis et beatae necessitatibus eos illum, labore alias inventore explicabo a doloribus architecto, fugit esse! Harum, enim error?
          ...
          <ButtonLink link="/signUp" text="Create Account" className="py-2 text-lg text-semibold px-4" classLink="hover:text-footer-color text-white" />
        </div>
