        ...
        <section className='bg-ground-color'>
            ...
            <div className="grid sm:grid-cols-2 custom-min:grid-cols-1 custom-min:gap-8 place-items-center custom-min:pt-8 sm:pt-16 lg:px-24 sm:gap-4 md:gap-16 lg:gap-48 h-full">
                ...
                <div className="flex gap-4 flex-col px-16 ">
                    ...
                    <h1 style={{ lineHeight: '1.3' }} className="sm:text-3xl md:text-5xl z-10 font-semibold">
                        Providing Consulting <br /> Services & Business <br /> Management
                    </h1>
                ...
                <div className="flex flex-col gap-8 px-16">
                    <div>
                        ...
                        <p className="sm:w-3/4 text-text-color">Lorem ipsum Molestiae, accusantium fugiat debitis laborum quibusdam quos quis qui atque nameiciendis, minima.</p>
                    </div>
                    <div>
                        <div className='flex gap-4 items-center mb-4'>
                            <span className="bg-base-color py-2.5 px-3 rounded-full inline-block">{ClickIcon && <ClickIcon width="20px" height="16px" />}</span>
            ...
            <div className='mb-8 relative'>
                ...
                <h3 style={{ lineHeight: '1.3' }}  className='custom-min:2xl custom-md:text-3xl sm:text-5xl font-semibold absolute top-[20%] custom-min:left-[30%] md:left-[30%] mb-8'>Believe us when its come to <br /> Consultant & Management</h3>
                <div>
