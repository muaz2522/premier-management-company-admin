...
function Specialty() {
    return (
        <div className="pb-6 sm:px-24 custom-min:px-8 bg-core-color">
            <h1 className="text-[12rem] text-special-color text-center" style={{fontFamily:"Colonna MT"}}>OUR SPECIALTY</h1>
            <div className="grid lg:grid-cols-3 custom-min:gap-8 sm:grid-cols-2 custom-min:grid-cols-1 pb-8">
