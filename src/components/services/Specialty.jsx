...
function Specialty() {
    return (
        <div className="py-16 px-32 bg-core-color">
            ...
            <div className="grid lg:grid-cols-3 md:gap-8 md:grid-cols-2 py-8">
                <div className="relative flex justify-center">
                    <img src={specialty1} alt="specialty image" className="w-[80%] " />
                    <div className="bg-white py-2 absolute bottom-4 w-[70%] text-center font-medium">HR Consultant</div>
                </div>
                <div className="relative flex justify-center">
                    <img src={specialty2} alt="specialty image" className="w-[80%] " />
                    <div className="bg-white py-2 absolute bottom-4 font-medium text-center w-[70%]">Business Management</div>
                </div>
                <div className="relative flex justify-center">
                    <img src={specialty3} alt="specialty image" className="w-[80%] " />
