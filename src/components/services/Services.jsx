...
function Services() {
    return (
        <div className="py-16 sm:px-20 custom-min:px-24">
            ...
            <div className='grid lg:grid-cols-4 place-items-center md:grid-cols-3 sm:grid-cols-2 custom-md:grid-cols-1 custom-min:gap-8 py-8'>
                <div className='relative'>
                    <div className="w-72 h-80 rounded bg-core-color">
                        {ServiceImageIcon && <ServiceImageIcon />}
                    </div>
                    <h3 className='font-semibold text-2xl absolute top-16 left-4'>Project <br/> Management</h3>
