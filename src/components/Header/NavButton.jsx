...
function NavButton() {
    return (
        <div className="flex sm:flex-row custom-min:flex-col custom-min:gap-4 md:gap-8 custom-min:mt-8 sm:mt-0 ">
            <button className="sm:border sm:rounded-3xl custom-min:items-center sm:items-start flex items-center h-[35px] custom-min:flex-col custom-min:gap-4 sm:gap-0 sm:flex-row border-slate-300">
            ...
            <ButtonLink link="/contact" text="Get in touch" className="px-3" classLink=" hover:text-footer-color text-lg h-[35px] text-medium text-white" />
        </div>
    )
}
