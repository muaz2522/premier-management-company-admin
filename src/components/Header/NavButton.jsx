...
function NavButton() {
    ...
    return (
        <div className="flex sm:flex-row custom-min:flex-col custom-min:gap-4 md:gap-8 custom-min:mt-8 sm:mt-0 ">
            {auth.currentUser ? <ButtonLink link="/dashboard" text="Dashboard" className="px-3" classLink=" hover:text-footer-color text-base text-white" />
                :
            ...
            <ButtonLink link="/contact" text="Get in touch" className="py-2 px-3" classLink=" hover:text-footer-color text-base text-white" />
        </div>
    )
}
