...
function Strategic() {
    return (
        <section>
            <div>
                <div className=" py-16 custom-md:px-24 custom-min:px-8">
                    <h3 className='font-semibold text-xl text-base-color'>OUR SERVICES</h3>
                    <h1 className='text-4xl font-semibold py-4'>Strategic Business <br /> Management</h1>
                </div>
                <div className='custom-md:px-12 grid md:grid-cols-4 sm:grid-cols-3 custom-md:grid-cols-2 custom-min:grid-cols-1 custom-min:gap-y-2 custom-min:place-items-center custom-md:place-items-start md:gap-0'>
                    <div className='flex flex-col gap-4 border px-8 py-16 custom-min:w-3/4 custom-md:w-full'>
            ...
            <div className=' custom-min:px-8 custom-md:px-24 py-8'>
                <h1 className="text-4xl text-center font-semibold">Building Experience & Give <br /> High Success Rates</h1>
                <div className='grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1  md:gap-8 lg:gap-0 md:p-24 custom-min:pt-16'>
                    <div className='flex md:flex-col sm:flex-row custom-min:flex-col custom-min:gap-4 md:gap-0 items-center'>
                        <div className='bg-core-color custom-min:w-3/4 sm:w-full lg:w-3/4 py-4 text-center text-base-color mb-4'>
                            <h1 className='text-4xl font-bold mb-1'>900+</h1>
                            <h3 className='font-medium'>Gave Advices</h3>
                        </div>
                        <div className='bg-core-color custom-min:w-3/4 sm:w-full lg:w-3/4 p-4 text-center text-base-color mb-4'>
